...
//! compiled in (lz4, zstd, zlib and bzip2 as of M3.1 parts 2a-2d; xz follows, each verified
//! before the next, each proven by a fixture pair under `core/fixtures/` generated by
